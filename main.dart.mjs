...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1358: () => new Map(),
      _1359: (x0,x1,x2) => x0.set(x1,x2),
      _1360: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1361: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1361(f,arguments.length,x0,x1) }),
      _1362: (x0,x1) => new ZXing.BrowserMultiFormatReader(x0,x1),
      ...
      _1365: x0 => x0.getVideoTracks(),
      _1366: x0 => x0.getCapabilities(),
      _1367: () => ({}),
      _1368: x0 => x0.getSettings(),
      _1369: x0 => x0.getSupportedConstraints(),
      _1370: x0 => ({video: x0}),
      _1371: x0 => ({facingMode: x0}),
      _1372: (x0,x1) => x0.getUserMedia(x1),
      _1380: x0 => x0.barcodeFormat,
      _1381: x0 => x0.text,
      _1382: x0 => x0.rawBytes,
      _1383: x0 => x0.resultPoints,
      _1385: Date.now,
      ...
      _1423: Object.is,
      _1424: o => o instanceof Array,
      _1425: (a, i) => a.push(i),
      _1429: a => a.pop(),
      _1430: (a, i) => a.splice(i, 1),
      _1431: (a, s) => a.join(s),
      _1432: (a, s, e) => a.slice(s, e),
      _1434: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1435: a => a.length,
      _1437: (a, i) => a[i],
      _1438: (a, i, v) => a[i] = v,
      _1440: o => {
      ...
      _1441: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1443: o => o instanceof Uint8Array,
      _1444: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1445: o => o instanceof Int8Array,
      _1446: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1447: o => o instanceof Uint8ClampedArray,
      _1448: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1449: o => o instanceof Uint16Array,
      _1450: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1451: o => o instanceof Int16Array,
      _1452: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1453: o => o instanceof Uint32Array,
      _1454: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1455: o => o instanceof Int32Array,
      _1456: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1458: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1459: o => o instanceof Float32Array,
      _1460: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1461: o => o instanceof Float64Array,
      _1462: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1463: (t, s) => t.set(s),
      _1465: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1467: o => o.buffer,
      _1468: o => o.byteOffset,
      _1469: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1470: (b, o) => new DataView(b, o),
      _1471: (b, o, l) => new DataView(b, o, l),
      _1472: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1473: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1474: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1475: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1476: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1477: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1478: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1479: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1480: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1481: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1482: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1483: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1486: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1487: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1488: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1489: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1490: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1491: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1504: (ms, c) =>
      ...
      _1604: x0 => x0.getReader(),
      _1605: x0 => x0.cancel(),
      _1606: x0 => x0.read(),
      _1607: x0 => x0.attachStreamToVideo,
      _1609: x0 => x0.decodeContinuously,
      _1613: x0 => x0.reset,
      _1615: x0 => x0.stopContinuousDecode,
      _1617: x0 => x0.stream,
      _1618: x0 => x0.videoElement,
      _1619: (x0,x1) => ({width: x0,height: x1}),
      _1620: (x0,x1,x2) => ({width: x0,height: x1,facingMode: x2}),
      _1621: x0 => x0.getCapabilities,
      _1622: x0 => x0.facingMode,
      _1624: x0 => x0.random(),
      _1627: () => globalThis.Math,
      ...
      _1688: x0 => x0.x,
      _1689: x0 => x0.y,
      _1786: (x0,x1) => { x0.lang = x1 },
      _1815: x0 => x0.style,
      _1874: (x0,x1) => { x0.onerror = x1 },
      _1890: (x0,x1) => { x0.onload = x1 },
      _1914: (x0,x1) => { x0.onpause = x1 },
      _1916: (x0,x1) => { x0.onplay = x1 },
      ...
      _3060: (x0,x1) => { x0.defer = x1 },
      _3062: (x0,x1) => { x0.crossOrigin = x1 },
      _3520: () => globalThis.window,
      _3583: x0 => x0.navigator,
      _3956: x0 => x0.mediaDevices,
      _6127: x0 => x0.signal,
      _6199: () => globalThis.document,
      _6281: x0 => x0.body,
      _6283: x0 => x0.head,
      _6615: (x0,x1) => { x0.id = x1 },
      _7961: x0 => x0.value,
      _7963: x0 => x0.done,
      _8660: x0 => x0.url,
      _8662: x0 => x0.status,
      ...
      _8665: x0 => x0.headers,
      _8666: x0 => x0.body,
      _9489: x0 => x0.facingMode,
      _9703: x0 => x0.width,
      _9705: x0 => x0.height,
      _9711: x0 => x0.facingMode,
      _11231: (x0,x1) => { x0.height = x1 },
      _11425: (x0,x1) => { x0.objectFit = x1 },
      _11555: (x0,x1) => { x0.pointerEvents = x1 },
      _11853: (x0,x1) => { x0.transform = x1 },
      _11857: (x0,x1) => { x0.transformOrigin = x1 },
      _11921: (x0,x1) => { x0.width = x1 },
      _12289: x0 => x0.name,
